...
ActiveRecord::Schema.define(version: 20180212103515) do
  ...
  create_table "devides", force: :cascade do |t|
    t.float "percent"
    t.bigint "expense_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["expense_id"], name: "index_devides_on_expense_id"
  end
  ...
  add_foreign_key "devides", "expenses"
end
